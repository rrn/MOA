...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"showFilerDetail"]) {
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        FilterdExploreSearchViewController *destViewController = segue.destinationViewController;
        destViewController.filterName = [tableData objectAtIndex:indexPath.row];
    }
}
