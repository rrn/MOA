...
static NSString * const itemLayoutPhotoCellKind = @"itemCell";
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[itemLayoutPhotoCellKind] = cellLayoutInfo;
...
{
    return self.layoutInfo[itemLayoutPhotoCellKind][indexPath];
}
